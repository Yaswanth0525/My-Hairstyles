      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-8">
            ...
            <p className="text-gray-600 text-lg">View all current and past bookings</p>
          </div>
        </div>
      </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        {bookings.length === 0 ? (
          <motion.div 
            ...
            animate={{ opacity: 1, scale: 1 }}
            className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 text-center py-16"
          >
          ...
          <div className="grid gap-6">
            {bookings.map((booking, index) => (
              <motion.div
                ...
                className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]"
              >
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700">{formatDate(booking.datetime)}</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <ClockIcon className="h-5 w-5 text-gray-400" />
                        <span className="text-gray-700">{formatTime(booking.datetime)}</span>
                      </div>
                    </div>
                  </div>
                </div>
